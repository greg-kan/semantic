package kz.kazniisa.jena_shacl_classification_rule;
...
import kz.kazniisa.jena_shacl_rule_execution.ShaclRuleExecution;
...
public class ShaclClassificationRule {
    ...
    public static void main(String[] args) {
        try {
            ...
            String data = "file:" + path.toFile().getAbsolutePath() + "/data/bakery.ttl";
            String shape = "file:" + path.toFile().getAbsolutePath() + "/data/bakeryRules.ttl";
            ...
            if (!validity.isValid()) {
                ...
                inferenceModel = RuleUtil.executeRules(infModel, shapeModel,
                        inferenceModel, null);
                String inferences = path.toFile().getAbsolutePath() + "/data/classification_inferences.ttl";
