package kz.kazniisa.jena_shacl_rdf_validation;
...
public class ShaclValidation {
    ...
    public static void main(String[] args) {
        try {
            ...
            String data = "file:" + path.toFile().getAbsolutePath() + "/data/person.ttl";
            String shape = "file:" + path.toFile().getAbsolutePath() +"/data/personShape.ttl";
            ...
            if (!conforms) {
                String report = path.toFile().getAbsolutePath() + "/data/person_report.ttl";
