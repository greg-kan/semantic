package kz.kazniisa.jena_shacl_rule_execution;
...
public class ShaclRuleExecution {
    ...
    public static void main(String[] args) {
        try {
            ...
            String data = "file:" + path.toFile().getAbsolutePath() + "/data/rectangles.ttl";
            String shape = "file:" + path.toFile().getAbsolutePath() + "/data/rectangleRules.ttl";
            ...
            inferenceModel = RuleUtil.executeRules(dataModel, shapeModel,
                    inferenceModel, null);
            String inferences = path.toFile().getAbsolutePath() + "/data/rectangles_inferences.ttl";
